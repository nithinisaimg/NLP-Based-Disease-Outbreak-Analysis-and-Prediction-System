...
import HealthTextPanel from "@/components/epiglobe/HealthTextPanel";
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "NLP-Based Disease Outbreak Analysis and Prediction System" },
      {
        name: "description",
        content:
          "Integrated dashboard for disease spread prediction (SIR) and NLP-based health text intelligence.",
      },
    ],
  }),
});
...
function Index() {
  ...
  const [showHealthText, setShowHealthText] = useState(false);
    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#050A14" }}>
      ...
      <div className="absolute top-0 left-0 right-0 z-20">
        <NavBar
          ...
          onOpenHealthText={() => setShowHealthText(true)}
        />
      ...
      {showHealthText && <HealthTextPanel onClose={() => setShowHealthText(false)} />}
